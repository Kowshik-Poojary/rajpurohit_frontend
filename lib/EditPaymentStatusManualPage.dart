...
class _EditPaymentStatusManualPageState extends State<EditPaymentStatusManualPage>
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'Enter your credentials to update payment status',
                    style: TextStyle(
                      fontSize: 12,
                      color: Colors.grey,
                    ),
                            ...
                            Expanded(
                              child: GestureDetector(
                                onTap: _isLoading
                                    ? null
                                    : () =>
                                    setState(() => _selectedStatus = 'Unpaid'),
                                child: Container(
                                  padding: const EdgeInsets.symmetric(
                                    horizontal: 16,
                                    vertical: 14,
